...
from src.processors.consignment_order import ConsignmentProcessor

class ConsignmentTab(QWidget):
    def __init__(self):
        super().__init__()
        self.initUI()
        self.processor = None
    ...
    def initUI(self):
        ...
        self.status_label = QLabel('작성한 위탁발주 양식 파일을 첨부해주세요')
    ...
    def process_file(self):
        try:
            ...
            self.processor = ConsignmentProcessor(self.excel_file, save_folder)
    ...
    def reset_ui(self):
        self.status_label.setText('파일을 선택해주세요')
